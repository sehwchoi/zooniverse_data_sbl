...
field_2_name = 'testresult_list'
field_3_name = "test_result_exist_yes_percent"
...
def process_aggregation(subj, cl_counter, aggregated_bin_1, aggregated_bin_2):
    ...
    if cl_counter > some_limit: 
        ...
        out_put_2 = aggregated_bin_2
        out_put_3 = aggregated_bin_1[1] / cl_counter * 100
...
with open(outlocation, 'w', newline='') as file:
    ...
    with open(location) as f:
        ...
        subject = ''
        i = 1
        bin_1 = ['' for count in range(0, 2)]   # example for a list of known length  ( here 5,
        ...
        for row in r:
            ...
            if new_subject != subject:
                if i != 1:  # if not the first line, we have aggregated all the classifications for
                    ...
                    process_aggregation(subject, i, bin_1, bin_2)
