...
input = r'/Users/stellachoi/Documents/SDL/zooniverse/SBL/' \
           r'flatten_classification_south-bend-lead.csv'

output = r'/Users/stellachoi/Documents/SDL/zooniverse/SBL/' \
           r'sorted_flattened_south-bend-lead.csv'

print(sort_file(input, output, 1), 'lines sorted and written')
